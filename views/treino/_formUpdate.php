...
<div class="treino-form">
    ...
    <form action="<?= Url::to(['treino/create']) ?>" method="post">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <input class="form-control" type="text" name="Treino[nome]" id="inputNome" placeholder="Ex: Ombro" required value="<?= $modelTreino['nome'] ?>"/>
            </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row" style="height: 20em;">
                            ...
                            <div class="card border-success col-md-12 pb-2">
                                ...
                                <div style="display: flex; flex-direction: column;" class="card-body" id="selecionado">

                                    <input name="Exercicio[]" value=" idElement " hidden/> <span class="text-success"> <i class="fas fa-check me-1"></i> nomePeso </span>
                                    <button id="btn idElement " type="button" class="btn btn-outline-danger btn-sm ms-2"> <i class="fas fa-trash"></i></button>
